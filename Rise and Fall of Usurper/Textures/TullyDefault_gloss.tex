...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\MyDocuments\Firaxis ModBuddy\NB2 Library\Tully\HosterTully\Maps\TullyDefault_gloss.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3998408485</m_ExportedTime>
	<m_ClassName text="Leader_Gloss"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="TullyDefault_gloss.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="TullyDefault_gloss"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
