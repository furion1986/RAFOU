...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\MyDocuments\Firaxis ModBuddy\NB2 Library\Tyrell\Mace_Unfolded\MaceDefault_AO.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3352956343</m_ExportedTime>
	<m_ClassName text="Leader_AO"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="MaceDefault_AO.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="MaceDefault_AO"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
